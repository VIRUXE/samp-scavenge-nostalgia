...
hook OnPlayerScriptUpdate(playerid) {
    ...
    // Obtem a intensidade da infeção, o índice da animação, as teclas pressionadas e o nível de comida do jogador
    new 
    ...
    // Mostra um texto de ação para o jogador quando a comida estiver em um nível crÃ­tico
    ...
    // Define o nível de embriaguez do jogador com base no nível de comida e intensidade da infeção,
