...
LoadAccount(playerid) {
	...
	printf("[ACCOUNTS] %p (%d) carregou conta. (ùltimo Login: %T, Registrado em: %T, VIP: %s, Ultimo Respawn: %T, Clan: %s, Total de Spawns: %d, Total de Avisos: %d, Kills: %d, Total de Mortes: %d, Total de Tempo Vivo: %d, Coins: %d, Vivo?: %s)",
