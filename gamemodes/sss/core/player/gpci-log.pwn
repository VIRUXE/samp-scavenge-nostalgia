...
/* stock AskForWindowsUsername(playerid) {
	Dialog_Show(playerid, WindowsUsername, DIALOG_STYLE_INPUT, "Insira o motivo do banimento", "Digite o motivo do banimento abaixo. O limite de caracteres é 128. ApÃ³s essa tela, Você definirÃ¡ a duração do banimento.", "Continuar", "Cancelar");
}
