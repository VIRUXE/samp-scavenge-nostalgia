...
#define PLAYER_LIST_MAX_ITEMS	(50)
...
_ShowCurrentList(playerid)
{
	Dialog_Show(playerid, PlayerList, DIALOG_STYLE_LIST, "Lista de players", pls_String[playerid], "Selecionar", "Fechar");
}
...
/*ACMD:profile[2](playerid)
{
	ShowPlayerDialog(playerid, 10008, DIALOG_STYLE_MSGBOX, params, GetPlayerInfo(params), "Fechar", "");
