...
ACMD:history[1](playerid, params[])
{
	...
	else return ChatMsg(playerid, YELLOW, " >  O tipo de pesquisa deve ser um dos: 'i'(ip) 'h'(hash), o par√¢metro opcional 'n' lista o hist√≥rico apenas para esse jogador.");
...
ACMD:comandoslvl1[1](playerid)
{
    ...
    strcat(stringlvl1, "{FFFF00}Comandos dos Admins NÌvel 1:\n");
    ...
    strcat(stringlvl1, ""C_BLUE"/blockrr - Bloquear alguÈm de enviar relat√≥rio\n");
