...
ACMD:rr[1](playerid, params[])
{
	...
	new string[500];
	format(string, 500, "[RelatÃ³rio] %p(id:%d) respondeu: "C_WHITE"%s", playerid, playerid, msg);
	ChatMsg(prid, GREEN, string);

	ChatMsg(prid, GREEN, "="C_WHITE"="C_GREEN"="C_WHITE"="C_GREEN"="C_WHITE"="C_GREEN"="C_WHITE"="C_GREEN"="C_WHITE"="C_GREEN"="C_WHITE"="C_GREEN"=");

	format(string, 500, " > %p(id:%d) respondeu o relatÃ³rio de %p(id:%d): %s", playerid, playerid, prid, prid, msg);
...
CMD:relatorio(playerid, params[])
{
	...
	{
		ChatMsg(playerid, YELLOW, "server/command/cant-use-not-logged-in");
		return 1;
	}
    ...
    ChatMsgAdmins(1, BLUE, "[RelatÃ³rio]: %p(id:%d)"C_BLUE": "C_WHITE"%s", playerid, playerid, msg);
    ChatMsgAdmins(1, BLUE, "="C_WHITE"="C_BLUE"="C_WHITE"="C_BLUE"="C_WHITE"="C_BLUE"="C_WHITE"="C_BLUE"="C_WHITE"="C_BLUE"="C_WHITE"="C_BLUE"=");
    ...
    ChatMsg(playerid, YELLOW, " > RelatÃ³rio enviado com sucesso. Aguarde a administraÃ§Ã£o do servidor.");
	return 1;
}
...
ShowReportReasonInput(playerid)
{
	Dialog_Show(playerid, ReportReasonInput, DIALOG_STYLE_INPUT, "Motivo do report", "Digite o motivo do seu relatÃ³rio abaixo.", "Reportar", "Voltar");
}
