...
FormatBanReasonDialog(playerid)
{
	Dialog_Show(playerid, BanReason, DIALOG_STYLE_INPUT, "Insira o motivo do banimento", "Digite o motivo do banimento abaixo. O limite de caracteres é 128. ApÃ³s essa tela, Você definirÃ¡ a duraÃ§Ã£o do banimento.", "Continuar", "Cancelar");
}
...
FormatBanDurationDialog(playerid)
{
	Dialog_Show(playerid, BanDuration, DIALOG_STYLE_INPUT, "Insira a duraÃ§Ã£o do banimento", "Enter the ban duration below. You can type a number then one of either: 'days', 'weeks' or 'months'. Type 'forever' for perma-ban.", "Continuar", "Voltar");
