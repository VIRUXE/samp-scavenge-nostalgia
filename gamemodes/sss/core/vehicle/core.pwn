...
// Esconde o status de reparo do VeÌculo, ap√≥s 3 segundos.
...
// Mostra o status de reparo do VeÌculo, durante 3 segundos.
ShowRepairStatus(playerid, vehicleid, bool:hide = true) {
	...
	if(hide)
		defer HideRepairStatus(playerid); // Esconde o status de reparo do VeÌculo, ap√≥s 3 segundos.
}
