...
//140
	item_PoliceCap		= DefineItemType("Boné Policial",			"PoliceCap",		18636,	1,	0.0, 0.0, 0.0,			0.05,	0.225000, 0.034000, 0.014000, 81.799942, 7.699998, 179.999954, .maxhitpoints = 1);
...
//	DefineItemCraftSet(item_Bottle, item_Bottle, true, item_Bottle, true);
	...
	drug_DTPA		= DefineDrugType("Ácido DTPA",	300000);
