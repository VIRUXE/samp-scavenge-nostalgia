...
//140
	item_PoliceCap		= DefineItemType("Bonù Policial",			"PoliceCap",		18636,	1,	0.0, 0.0, 0.0,			0.05,	0.225000, 0.034000, 0.014000, 81.799942, 7.699998, 179.999954, .maxhitpoints = 1);
...
// 220
	...
	item_RedApple		= DefineItemType("Maùù Vermelha",			"RedApple",			19575,	1,	170.0, 0.0, 0.0,		0.03,	0.100000, 0.039000, 0.018000,  4.400032, -2.300116, 138.699905, .maxhitpoints = 1);
...
// 230
	item_AppleJuice		= DefineItemType("Suco de Maùù",			"AppleJuice",		19564,	1,	0.0, 0.0, 0.0,			0.039,	0.099000, 0.009999, 0.145999,  -161.999969, 8.400005, -1.699998, .maxhitpoints = 1);
...
// 250
	...
	item_GrnApple		= DefineItemType("Maùù verde",				"GrnApple",			19576,	1,	0.0, 0.0, 0.0,			0.03,	0.107000, 0.039000, 0.014999,  -168.799911, -161.400177, -0.400169, .maxhitpoints = 1);
...
//										model name	 			group			 	category						size					maxfuel	fuelcons	lootindex				trunksize	spawnchance	flags
	veht_Bobcat		= DefineVehicleType(422, "Bobcat",			vgroup_Civilian,	VEHICLE_CATEGORY_TRUCK,			VEHICLE_SIZE_MEDIUM,	60.0,		16.0,	"vehicle_industrial",		40,		30.0);
...
//   70
	...
	veht_Cabbie   	= DefineVehicleType(438, "Cabbie",		    vgroup_Industrial,	VEHICLE_CATEGORY_CAR,			VEHICLE_SIZE_MEDIUM,	45.0,		10.0,	"vehicle_industrial",		50,	    30.0);
...
// 80
	...
	veht_Super	    = DefineVehicleType(506, "Super GT",		vgroup_Civilian,	VEHICLE_CATEGORY_CAR,			VEHICLE_SIZE_SMALL,		45.0,		20.0,	"vehicle_civilian",		    45,	    20.0);
	veht_Turismo    = DefineVehicleType(451, "Turismo",			vgroup_Unique,	    VEHICLE_CATEGORY_CAR,			VEHICLE_SIZE_SMALL,		45.0,		30.0,	"vehicle_civilian",		    45,	    15.0);
// 90
