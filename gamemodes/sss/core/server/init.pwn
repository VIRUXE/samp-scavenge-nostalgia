...
// 220
	...
	item_RedApple		= DefineItemType("Ma�a Vermelha",			"RedApple",			19575,	1,	170.0, 0.0, 0.0,		0.03,	0.100000, 0.039000, 0.018000,  4.400032, -2.300116, 138.699905, .maxhitpoints = 1);
...
// 230
	item_AppleJuice		= DefineItemType("Suco de Ma�a",			"AppleJuice",		19564,	1,	0.0, 0.0, 0.0,			0.039,	0.099000, 0.009999, 0.145999,  -161.999969, 8.400005, -1.699998, .maxhitpoints = 1);
...
// 250
	...
	item_GrnApple		= DefineItemType("Ma�a verde",				"GrnApple",			19576,	1,	0.0, 0.0, 0.0,			0.03,	0.107000, 0.039000, 0.014999,  -168.799911, -161.400177, -0.400169, .maxhitpoints = 1);
...
//	DefineDefenceItem(item_DupleDoor, 	0.0, 0.0, 90.0,		0.0, 90.0, 90.0,  	1.26817, true); // 8
	...
	*/
	...
	DefineSeedType("Ma�a", item_RedApple,	5, 802, 0.72044);
	DefineSeedType("Ma�a", item_GrnApple,	5, 802, 0.72044);
	...
	liquid_Apple			= DefineLiquidType("Suco de Ma�a",			1.0);
