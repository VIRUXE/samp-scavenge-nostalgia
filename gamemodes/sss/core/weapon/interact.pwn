...
_TransferWeaponToWeapon(playerid, srcitem, tgtitem)
{
	...
	if(reserveammo + magammo > 0)
	{
		...
		ShowActionText(playerid, sprintf(GetLanguageString(GetPlayerLanguage(playerid), "common/empty"), (reserveammo + magammo) - remainder), 3000);
	}
...
_TransferTinToWeapon(playerid, srcitem, tgtitem)
{
	...
	if(ammo > 0)
	{
		...
		ShowActionText(playerid, sprintf(GetLanguageString(GetPlayerLanguage(playerid), "common/empty"), ammo - remainder), 3000);
	}
...
_TransferWeaponToTin(playerid, srcitem, tgtitem)
{
	...
	ShowActionText(playerid, sprintf(GetLanguageString(GetPlayerLanguage(playerid), "common/empty"), amount), 3000);
