...
hook OnGameModeInit()
{
	...
	// Main Gate
	buttonid[0] = CreateButton(117.8747, 1932.3739, 19.5773, "Pressione para ativar a grade");
	...
	// Airstrip Gate
	buttonid[0] = CreateButton(280.7763, 1828.0514, 2.3915, "Pressione para ativar a grade");
