...
hook OnButtonPress(playerid, buttonid)
{
	...
	for(new i; i < lck_Total; i++)
	{
		...
		if(buttonid == lck_Data[i][lck_extButton])
		{
			...
			{
				ShowActionText(playerid, GetLanguageString(playerid, "NEARBYKEYP", true));
...
LoadLockup_SF()
{
	...
	CreateStaticLootSpawn(-2493.80151, 311.45721, 1035.89465, world_survivor, 25, 4);
	CreateStaticLootSpawn(-2493.62427, 314.89218, 1035.89514, world_survivor, 25, 4);
	CreateStaticLootSpawn(-2501.56641, 310.20535, 1035.89514, world_survivor, 25, 4);
	CreateStaticLootSpawn(-2497.18896, 310.38626, 1035.89502, world_survivor, 25, 4);
