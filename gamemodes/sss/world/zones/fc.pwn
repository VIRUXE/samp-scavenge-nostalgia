...
FC_District_Chilliad()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_Chilliad' {1589FF}por favor, aguarde...");
...
FC_District_AngelPine()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_AngelPine' {1589FF}por favor, aguarde...");
...
FC_District_Scrapyard()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_Scrapyard' {1589FF}por favor, aguarde...");
...
FC_District_Farms()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_Farms' {1589FF}por favor, aguarde...");
...
FC_District_EasterChem()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_EasterChem' {1589FF}por favor, aguarde...");
...
FC_District_FallenTree()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_FallenTree' {1589FF}por favor, aguarde...");
...
FC_District_FlintGen()
{
	ChatMsgAll(LBLUE, " >  Carregando regi�o do mundo: {FF8A14}'FC_District_FlintGen' {1589FF}por favor, aguarde...");
