...
public OnObjectMoved(objectid)
{
	...
	if(objectid == Obj_Elevator)   // The elevator reached the specified floor.
	{
	    ...
	    Label_Elevator	= Create3DTextLabel("Pressione 'F' para usar o elevador", 0xFFFFDD, 1784.9822, -1302.0426, z - 0.9, 4.0, 0, 1);
...
stock Elevator_Initialize()
{
	...
	Label_Elevator          = Create3DTextLabel("Pressione 'F' para usar o elevador", 0xFFFFDD, 1784.9822, -1302.0426, 13.6491, 4.0, 0, 1);
