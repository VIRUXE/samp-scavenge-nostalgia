...
sif_SetUpPlayer(playerid)
{
	...
	ActionText[playerid]			=CreatePlayerTextDraw(playerid, 320.000000, 316.000000, "_");
...
{
	if(GetPlayerState(playerid) != PLAYER_STATE_SPECTATING && !IsPlayerInAnyVehicle(playerid) && !IsPlayerNPC(playerid))
	{
