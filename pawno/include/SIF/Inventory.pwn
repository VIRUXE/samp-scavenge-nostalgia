...
- call: If true, will call OnItemRemoveFInventory.
*/
...
forward OnItemRemoveFInventory(playerid, itemid, slot);
/*
# Called
...
forward OnItemRemovedFInventory(playerid, itemid, slot);
/*
# Called
...
stock RemoveItemFromInventory(playerid, slotid, call = 1)
{
	...
	if(call)
	{
		if(CallLocalFunction("OnItemRemoveFInventory", "ddd", playerid, itemid, slotid))
			return 0;
	}
...
==============================================================================*/
	...
	#include <SIF\testing\Inventory.pwn>
#endif
